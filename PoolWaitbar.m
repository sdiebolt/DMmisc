classdef PoolWaitbar < handle
    % PoolWaitbar Progress bar that works with parallel code.
    % See https://fr.mathworks.com/matlabcentral/answers/465911-parfor-waitbar-how-to-do-this-more-cleanly
